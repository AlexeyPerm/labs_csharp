...
namespace TestLab10 {
	...
	public class TestFactory {
		...
		public void TestZeroFactory() {
			var fact = new Factory(null, null, 0, 0);
	...
	public class TestInsurance {
		...
		public void TestZeroInsurance() {
			var insurance = new InsuranceCompany(null, null, 0, 0);
	...
	public class TestLibrary {
		...
		public void TestZeroLibrary() {
			var Library = new Library(null, null, 0, 0);
	...
	public class TestShip {
		...
		public void TestZeroShip() {
			var Ship = new Shipyard(null, null, 0, 0, 0);
