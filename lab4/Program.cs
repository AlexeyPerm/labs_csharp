        ...
        static void Main()
        {
            ...
            while (!exit)
            {
                ...
                switch (input)
                {
                    case 1:
                    {
                        //заполнение массива рандомными числа и его вывод
                        RandomFilling(array, sizeArray);
                        break;
                    }
                    case 2:
                    {
                        //Ручное заполнение массива числами и его вывод
                    ...
                    case 6:
                    {
                        //Поиск элемента с заданным ключом в несортированном массиве 
                    ...
                    case 7:
                    {
                        //Поиск элемента с заданным ключом в сортированном методов выбора массиве 
                        Console.Write("Найти элемент в неотсортированном массиве:\n> ");
                        int searchElement = ParseInt();
